    ...
    <section className="relative pt-24 md:pt-32 pb-12 md:pb-20 px-6 max-w-7xl mx-auto flex flex-col items-center text-center overflow-hidden">
      ...
      <div className="animate-fade-up">
        ...
        <div className="grid grid-cols-1 sm:flex sm:flex-row flex-wrap gap-3 md:gap-4 justify-center items-center mb-10 w-full max-w-sm sm:max-w-none mx-auto px-4 sm:px-0">
          ...
          <a href={siteConfig.github} target="_blank" className="px-6 py-4 text-base font-bold text-zinc-400 hover:text-white transition-all flex items-center justify-center gap-2 group w-full sm:w-auto">
